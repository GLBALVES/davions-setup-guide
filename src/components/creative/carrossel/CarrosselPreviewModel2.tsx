...
const CarrosselPreviewModel2 = ({ slides, activeSlide, onSlideChange, tituloSerie, background, slideRef }: Props) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div ref={slideRef} className="relative aspect-[4/5] rounded-lg overflow-hidden max-w-md mx-auto flex flex-col">
        <div className="relative flex flex-col justify-start p-6 pb-4" style={{ ...getBackgroundStyle(bg, activeSlide), flex: "0 0 55%" }}>
        ...
        <div className="relative bg-muted" style={{ flex: "0 0 45%" }}>
          {slideImageUrl ? (
...
export default CarrosselPreviewModel2;
