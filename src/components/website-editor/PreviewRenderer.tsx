...
import SectionRenderer, { type PageSection, type EditContext } from "@/components/vitrine/SectionRenderer";
...
function FloatingBlockToolbar({
  ...
  return (
    <div className="absolute -top-3 right-2 z-30 flex items-center gap-0.5 bg-foreground/95 backdrop-blur-sm rounded-md px-1 py-0.5 shadow-lg pointer-events-auto">
        ...
        {editMode && onAddBlockAt && (
          ...
          >
            <button
              ...
              className="fixed bottom-16 right-8 z-40 inline-flex items-center gap-2 px-5 py-3 rounded-full bg-primary text-primary-foreground text-xs font-medium tracking-wide shadow-xl hover:bg-primary/90 hover:shadow-2xl transition-all"
              title={
                sections.length === 0
                  ? "Add section"
