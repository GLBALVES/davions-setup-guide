  ...
  return [
    {
      ...
      defaultOpen: true,
      items: [
        { title: t.nav.projects, icon: Columns, to: "/dashboard/projects", badgeKey: "projectUpdates" },
        ...
        { title: t.nav.website, icon: Globe, to: "/dashboard/website" },
    ...
    },
    {
      ...
      items: [
        ...
        { title: t.nav.feeAudit,          icon: Receipt,         to: "/dashboard/finance/fee-audit" },
...
const groups: MenuGroup[] = [
  {
    ...
    items: [
      { title: "Workflow", icon: Columns, to: "/dashboard/projects", badgeKey: "projectUpdates" },
