...
import { LayoutDashboard, Users, Bug, ArrowLeft, Shield, Sparkles, Globe, Server, FileText } from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/vps-setup", label: "VPS Setup", icon: Server },
  { to: "/admin/vps-docs", label: "VPS Docs", icon: FileText },
];
