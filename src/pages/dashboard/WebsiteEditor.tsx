...
import {
  ...
  ArrowRightToLine, ExternalLink, Newspaper, LayoutTemplate, Files, PanelsTopLeft, ShoppingBag, Monitor, Tablet, Smartphone,
} from "lucide-react";
...
const TABS: { id: EditorTab; icon: React.ElementType; label: string }[] = [
  { id: "pages", icon: PanelsTopLeft, label: "Pages" },
